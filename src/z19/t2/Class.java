...
public class Class extends JFrame {
    ...
    public Class(ArrayList<Student> students) {
        ...
        remStudentBtn.addActionListener(e -> remClicked());
        ...
        for (int i = 0; i < students.size(); i++) {
            ...
            startStudents[i][2] = ((Integer) (students.get(i).getNumGroup())).toString();
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (count == 2) {
                    ...
                    if (header.getHeaderRect(3).contains(e.getX(), e.getY()))
                        sortStudents(Student.BALL_COMP);
                }
            }
    ...
    private void sortStudents(Comparator<Student> comp) {
        ...
        for (int i = 0; i < students.size(); i++) {
            ...
            dtm.insertRow(i, new Object[] { st.getFio(), st.getAge(), st.getNumGroup(), st.getAvgPoint() });
        }
    }

    private void findClicked() throws NetStuda {
        ...
        throw new NetStuda(s);
    }

    private void remClicked() {
